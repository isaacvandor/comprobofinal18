...
class astar():
    def actualAStar(self,start,finish,map):
        ...
        """
        sizeOfRobot = 2 # determines the radius of the robot in pixels
    ...
    def plotPath(self,start,finish,Gs,map):
        ...
        solution.save("../maps/processed/solution_goodmap.png")
        #print('coord list:', ListOfCoordinates)
        return ListOfCoordinates
...
if __name__ == '__main__':
    ...
    #coordinates = nav.actualAStar((init_x_coord, init_y_coord), (dest_x_coord, dest_y_coord), "../maps/ac109_goodmap.png")
    #coordinates = nav.actualAStar((580,325),(585,190),"../maps/ac109_goodmap.png") #Coords for corner of map to round trashcan
